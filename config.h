...
static const char *clipmenucmd[] = { "clipmenu", "-m", dmenumon, "-fn", font, "-nb", colors[0][ColBG], "-nf", colors[0][ColFG], "-sb", colors[1][ColBG], "-sf", colors[1][ColFG], NULL };
static const char *screenshotcmd[] = { "import", "$(date -Iseconds).jpg", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_w,      focusmondet,    {.i = 0 } },
	{ MODKEY,                       XK_e,      focusmondet,    {.i = 1 } },
	{ MODKEY,                       XK_r,      focusmondet,    {.i = 2 } },
	{ MODKEY|ShiftMask,             XK_comma,  tagmon,         {.i = -1 } },
	{ MODKEY|ShiftMask,             XK_period, tagmon,         {.i = +1 } },
	{ MODKEY|ShiftMask,             XK_w,      tagmondet,      {.i = 0 } },
	{ MODKEY|ShiftMask,             XK_e,      tagmondet,      {.i = 1 } },
	{ MODKEY|ShiftMask,             XK_r,      tagmondet,      {.i = 2 } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
